...
void Vcore___024root__trace_chg_0_sub_0(Vcore___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,((0x7fffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_58))));
        ...
        bufp->chgBit(oldp+8,(((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_17)) 
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+11,(vlSelf->core__DOT__reg_0__DOT__casez_tmp),32);
        bufp->chgIData(oldp+12,(vlSelf->core__DOT__reg_0__DOT__casez_tmp_0),32);
        bufp->chgIData(oldp+13,((((IData)(vlSelf->core__DOT___decoder_io_out_pc_jump) 
        ...
        bufp->chgIData(oldp+14,(vlSelf->core__DOT__exu__DOT__result),32);
                                ...
                                : ((2U & (IData)(vlSelf->core__DOT___decoder_io_out_branch_type))
                                    ? ((1U & (IData)(vlSelf->core__DOT___decoder_io_out_branch_type))
                                        ...
                                        : (vlSelf->core__DOT__reg_0__DOT__casez_tmp 
                                           != vlSelf->core__DOT__reg_0__DOT__casez_tmp_0))
                                    : (IData)(vlSelf->core__DOT__exu__DOT__comp__DOT___io_result_T_18)))));
        bufp->chgIData(oldp+21,(vlSelf->core__DOT__exu__DOT___mem_read_data),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+22,(vlSelf->core__DOT__ifu__DOT__pc),32);
        bufp->chgIData(oldp+23,(vlSelf->core__DOT__reg_0__DOT__regs_0),32);
        bufp->chgIData(oldp+24,(vlSelf->core__DOT__reg_0__DOT__regs_1),32);
        bufp->chgIData(oldp+25,(vlSelf->core__DOT__reg_0__DOT__regs_2),32);
        bufp->chgIData(oldp+26,(vlSelf->core__DOT__reg_0__DOT__regs_3),32);
        bufp->chgIData(oldp+27,(vlSelf->core__DOT__reg_0__DOT__regs_4),32);
        bufp->chgIData(oldp+28,(vlSelf->core__DOT__reg_0__DOT__regs_5),32);
        bufp->chgIData(oldp+29,(vlSelf->core__DOT__reg_0__DOT__regs_6),32);
        bufp->chgIData(oldp+30,(vlSelf->core__DOT__reg_0__DOT__regs_7),32);
        bufp->chgIData(oldp+31,(vlSelf->core__DOT__reg_0__DOT__regs_8),32);
        bufp->chgIData(oldp+32,(vlSelf->core__DOT__reg_0__DOT__regs_9),32);
        bufp->chgIData(oldp+33,(vlSelf->core__DOT__reg_0__DOT__regs_10),32);
        bufp->chgIData(oldp+34,(vlSelf->core__DOT__reg_0__DOT__regs_11),32);
        bufp->chgIData(oldp+35,(vlSelf->core__DOT__reg_0__DOT__regs_12),32);
        bufp->chgIData(oldp+36,(vlSelf->core__DOT__reg_0__DOT__regs_13),32);
        bufp->chgIData(oldp+37,(vlSelf->core__DOT__reg_0__DOT__regs_14),32);
        bufp->chgIData(oldp+38,(vlSelf->core__DOT__reg_0__DOT__regs_15),32);
    }
    bufp->chgBit(oldp+39,(vlSelf->clock));
    bufp->chgBit(oldp+40,(vlSelf->reset));
    bufp->chgIData(oldp+41,(vlSelf->io_pc),32);
    bufp->chgIData(oldp+42,(vlSelf->io_value),32);
    bufp->chgIData(oldp+43,(vlSelf->io_addr),32);
    bufp->chgIData(oldp+44,(vlSelf->io_instr),32);
    bufp->chgIData(oldp+45,(vlSelf->io_inst_now),32);
    bufp->chgCData(oldp+46,((0x1fU & (vlSelf->io_instr 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+47,((0x1fU & (vlSelf->io_instr 
                                      >> 0x14U))),5);
    bufp->chgCData(oldp+48,((0x1fU & (vlSelf->io_instr 
                                      >> 7U))),5);
    bufp->chgBit(oldp+49,((1U & ((IData)((0x17U == 
