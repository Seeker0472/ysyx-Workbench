...
void Vcore___024root__trace_chg_0_sub_0(Vcore___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+13,(vlSelf->core__DOT__exu__DOT____Vcellinp__alu__io_in_src1),32);
        bufp->chgIData(oldp+14,(vlSelf->core__DOT__exu__DOT____Vcellinp__alu__io_in_src2),32);
        bufp->chgIData(oldp+15,(vlSelf->core__DOT__exu__DOT__alu__DOT__casez_tmp),32);
        bufp->chgQData(oldp+16,((0x7fffffffffffffffULL 
        ...
        bufp->chgBit(oldp+18,(((4U & (IData)(vlSelf->core__DOT___decoder_io_out_branch_type))
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+19,(vlSelf->core__DOT__ifu__DOT__pc),32);
        bufp->chgIData(oldp+20,(vlSelf->core__DOT__reg_0__DOT__regs_0),32);
        bufp->chgIData(oldp+21,(vlSelf->core__DOT__reg_0__DOT__regs_1),32);
        bufp->chgIData(oldp+22,(vlSelf->core__DOT__reg_0__DOT__regs_2),32);
        bufp->chgIData(oldp+23,(vlSelf->core__DOT__reg_0__DOT__regs_3),32);
        bufp->chgIData(oldp+24,(vlSelf->core__DOT__reg_0__DOT__regs_4),32);
        bufp->chgIData(oldp+25,(vlSelf->core__DOT__reg_0__DOT__regs_5),32);
        bufp->chgIData(oldp+26,(vlSelf->core__DOT__reg_0__DOT__regs_6),32);
        bufp->chgIData(oldp+27,(vlSelf->core__DOT__reg_0__DOT__regs_7),32);
        bufp->chgIData(oldp+28,(vlSelf->core__DOT__reg_0__DOT__regs_8),32);
        bufp->chgIData(oldp+29,(vlSelf->core__DOT__reg_0__DOT__regs_9),32);
        bufp->chgIData(oldp+30,(vlSelf->core__DOT__reg_0__DOT__regs_10),32);
        bufp->chgIData(oldp+31,(vlSelf->core__DOT__reg_0__DOT__regs_11),32);
        bufp->chgIData(oldp+32,(vlSelf->core__DOT__reg_0__DOT__regs_12),32);
        bufp->chgIData(oldp+33,(vlSelf->core__DOT__reg_0__DOT__regs_13),32);
        bufp->chgIData(oldp+34,(vlSelf->core__DOT__reg_0__DOT__regs_14),32);
        bufp->chgIData(oldp+35,(vlSelf->core__DOT__reg_0__DOT__regs_15),32);
    }
    bufp->chgBit(oldp+36,(vlSelf->clock));
    bufp->chgBit(oldp+37,(vlSelf->reset));
    bufp->chgIData(oldp+38,(vlSelf->io_pc),32);
    bufp->chgIData(oldp+39,(vlSelf->io_value),32);
    bufp->chgIData(oldp+40,(vlSelf->io_addr),32);
    bufp->chgIData(oldp+41,(vlSelf->io_instr),32);
    bufp->chgIData(oldp+42,(vlSelf->io_inst_now),32);
    bufp->chgCData(oldp+43,((0x1fU & (vlSelf->io_instr 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+44,((0x1fU & (vlSelf->io_instr 
                                      >> 0x14U))),5);
    bufp->chgCData(oldp+45,((0x1fU & (vlSelf->io_instr 
                                      >> 7U))),5);
    bufp->chgBit(oldp+46,((1U & ((IData)((0x17U == 
                                 ...
                                 | ((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_16)) 
                                    | ((0x7fU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_19)) 
                                       | (0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_40))))))));
    bufp->chgBit(oldp+47,(((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T)) 
                           | ((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_1)) 
                                                ...
                                                | ((0x7fffU 
                                                   ...
                                                   | ((0xffU 
                                                      ...
                                                      | ((0x7fffU 
                                                         ...
                                                         | (0x7fffU 
                                                            == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_57)))))))))))))));
    bufp->chgBit(oldp+48,(((0x1ffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_8)) 
                           | (IData)(((0x23U == (0x7fU 
                                                 & vlSelf->io_instr)) 
                                      & (IData)(vlSelf->core__DOT__decoder__DOT____VdfgRegularize_hb9908eda_0_59))))));
    bufp->chgIData(oldp+49,((0x3fffffffU & (~ (vlSelf->io_instr 
                                               >> 2U)))),30);
    bufp->chgIData(oldp+50,((((IData)(vlSelf->core__DOT___decoder_io_out_pc_jump) 
    ...
    bufp->chgQData(oldp+51,(vlSelf->core__DOT__exu__DOT__mrrm),35);
    bufp->chgIData(oldp+53,(vlSelf->core__DOT__exu__DOT__result),32);
    bufp->chgIData(oldp+54,(vlSelf->core__DOT__exu__DOT___mem_read_data),32);
}
