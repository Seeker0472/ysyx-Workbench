...
#endif
            VL_FATAL_MT("build/core.sv", 1343, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 1343, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 1343, "", "Active region did not converge.");
            }
