...
#endif
            VL_FATAL_MT("build/core.sv", 1333, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 1333, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 1333, "", "Active region did not converge.");
            }
