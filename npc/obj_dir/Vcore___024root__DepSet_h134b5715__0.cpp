...
#endif
            VL_FATAL_MT("build/core.sv", 595, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 595, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 595, "", "Active region did not converge.");
            }
