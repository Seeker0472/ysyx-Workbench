...
#endif
            VL_FATAL_MT("build/core.sv", 1341, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 1341, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 1341, "", "Active region did not converge.");
            }
