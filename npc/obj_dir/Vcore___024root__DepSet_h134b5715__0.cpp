...
#endif
            VL_FATAL_MT("build/core.sv", 1340, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/core.sv", 1340, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/core.sv", 1340, "", "Active region did not converge.");
            }
