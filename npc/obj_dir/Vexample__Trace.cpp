...
void Vexample::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vexample::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vexample__Syms* __restrict vlSymsp = static_cast<Vexample__Syms*>(userp);
    Vexample* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+2,(vlTOPp->f));
    }
}

void Vexample::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vexample__Syms* __restrict vlSymsp = static_cast<Vexample__Syms*>(userp);
    Vexample* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
