...
VL_ATTR_COLD void Vcore___024root__trace_init_sub__TOP__0(Vcore___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+32,0,"io_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+33,0,"io_value",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+34,0,"io_addr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,0,"io_instr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+36,0,"io_inst_now",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+35,0,"io_instr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+37,0,"io_out_rs1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+40,0,"io_out_alu_op_type",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+39,0,"decodedResults_invInputs",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 29,0);
    ...
    tracep->declBus(c+13,0,"io_in_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+40,0,"io_in_alu_op_type",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+33,0,"io_out_reg_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+40,0,"io_in_alu_op_type",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+41,0,"io_result",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declQuad(c+11,0,"sll",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 46,0);
    tracep->popPrefix();
    tracep->popPrefix();
    ...
    tracep->declBus(c+13,0,"io_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,0,"io_instr_i",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,0,"io_instr",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+30,0,"clock",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+31,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+37,0,"io_read_No_1",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+33,0,"io_reg_write_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vcore___024root__trace_full_0_sub_0(Vcore___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullBit(oldp+1,((0x7fffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_21))));
    ...
    bufp->fullBit(oldp+4,(((0x7fU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_6)) 
                           | ((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_11)) 
    ...
    bufp->fullIData(oldp+8,(((IData)(vlSelf->core__DOT___decoder_io_out_pc_jump)
                              ? 0U : ((IData)(4U) + vlSelf->core__DOT__ifu__DOT__pc))),32);
    bufp->fullIData(oldp+9,((((0x7fU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_6)) 
                              | ((0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_11)) 
                                 | ((0x7fU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_14)) 
                                    | (0xffU == (IData)(vlSelf->core__DOT__decoder__DOT___decodedResults_andMatrixOutputs_T_18)))))
    ...
    bufp->fullIData(oldp+10,(((IData)(vlSelf->core__DOT___decoder_io_out_alu_use_Imm_2)
                               ...
                               : vlSelf->core__DOT__reg_0__DOT__casez_tmp)),32);
    bufp->fullQData(oldp+11,((0x7fffffffffffULL & ((QData)((IData)(
                                                                   (((0x7fU 
                                                   ...
                                                   (0xfU 
                                                    & ((IData)(vlSelf->core__DOT___decoder_io_out_alu_use_Imm_2)
                                                        ? vlSelf->core__DOT__decoder__DOT__casez_tmp
                                                        : vlSelf->core__DOT__reg_0__DOT__casez_tmp))))),47);
    bufp->fullIData(oldp+13,(vlSelf->core__DOT__ifu__DOT__pc),32);
    bufp->fullIData(oldp+14,(vlSelf->core__DOT__reg_0__DOT__regs_0),32);
    bufp->fullIData(oldp+15,(vlSelf->core__DOT__reg_0__DOT__regs_1),32);
    bufp->fullIData(oldp+16,(vlSelf->core__DOT__reg_0__DOT__regs_2),32);
    bufp->fullIData(oldp+17,(vlSelf->core__DOT__reg_0__DOT__regs_3),32);
    bufp->fullIData(oldp+18,(vlSelf->core__DOT__reg_0__DOT__regs_4),32);
    bufp->fullIData(oldp+19,(vlSelf->core__DOT__reg_0__DOT__regs_5),32);
    bufp->fullIData(oldp+20,(vlSelf->core__DOT__reg_0__DOT__regs_6),32);
    bufp->fullIData(oldp+21,(vlSelf->core__DOT__reg_0__DOT__regs_7),32);
    bufp->fullIData(oldp+22,(vlSelf->core__DOT__reg_0__DOT__regs_8),32);
    bufp->fullIData(oldp+23,(vlSelf->core__DOT__reg_0__DOT__regs_9),32);
    bufp->fullIData(oldp+24,(vlSelf->core__DOT__reg_0__DOT__regs_10),32);
    bufp->fullIData(oldp+25,(vlSelf->core__DOT__reg_0__DOT__regs_11),32);
    bufp->fullIData(oldp+26,(vlSelf->core__DOT__reg_0__DOT__regs_12),32);
    bufp->fullIData(oldp+27,(vlSelf->core__DOT__reg_0__DOT__regs_13),32);
    bufp->fullIData(oldp+28,(vlSelf->core__DOT__reg_0__DOT__regs_14),32);
    bufp->fullIData(oldp+29,(vlSelf->core__DOT__reg_0__DOT__regs_15),32);
    bufp->fullBit(oldp+30,(vlSelf->clock));
    bufp->fullBit(oldp+31,(vlSelf->reset));
    bufp->fullIData(oldp+32,(vlSelf->io_pc),32);
    bufp->fullIData(oldp+33,(vlSelf->io_value),32);
    bufp->fullIData(oldp+34,(vlSelf->io_addr),32);
    bufp->fullIData(oldp+35,(vlSelf->io_instr),32);
    bufp->fullIData(oldp+36,(vlSelf->io_inst_now),32);
    bufp->fullCData(oldp+37,((0x1fU & (vlSelf->io_instr 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+38,((0x1fU & (vlSelf->io_instr 
                                       >> 7U))),5);
    bufp->fullIData(oldp+39,((0x3fffffffU & (~ (vlSelf->io_instr 
                                                >> 2U)))),30);
}
