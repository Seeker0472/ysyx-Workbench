...
VL_ATTR_COLD void Vcore___024root___dump_triggers__act(Vcore___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge core.br_han.clock)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vcore___024root___dump_triggers__nba(Vcore___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge core.br_han.clock)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vcore___024root___ctor_var_reset(Vcore___024root* vlSelf) {
    ...
    vlSelf->core__DOT__br_han__DOT__clock = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigprevexpr___TOP__core__DOT__br_han__DOT__clock__0 = VL_RAND_RESET_I(1);
