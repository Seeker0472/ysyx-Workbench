...
//
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div   , R, printf("%x---%x\n",src1,src2);MUXDEF(RV64,R(rd)=src2==0?-1:src1==INT64_MIN&&src2==-1?INT64_MIN: ((int64_t)src1)/((int64_t)(src2)),R(rd)=src2==0?-1:src1==INT32_MIN&&src2==-1?INT32_MIN:((int32_t)src1)/((int32_t)(src2))));
