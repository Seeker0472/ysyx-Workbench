...
//
  ...
  INSTPAT("10000?? ????? ????? 010 ????? 01011 11", amomin.w   , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,tmp>src2?src2:tmp);R(rd)=Ext8(tmp));
  INSTPAT("10100?? ????? ????? 010 ????? 01011 11", amomax.w   , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,tmp<src2?src2:tmp);R(rd)=Ext8(tmp));
  INSTPAT("11000?? ????? ????? 010 ????? 01011 11", amominu.w  , R, INV(s->pc));
  INSTPAT("11100?? ????? ????? 010 ????? 01011 11", amomaxu.w  , R, INV(s->pc));
