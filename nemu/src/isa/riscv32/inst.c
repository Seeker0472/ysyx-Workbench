...
int32_t add(int32_t src1, int32_t src2){
  return src1+src2;
}
...
//
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi   , I, printf("%x---%x---%x\n",src1,imm,src1+(imm));R(rd)=add(src1,imm););
