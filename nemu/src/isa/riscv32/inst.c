...
//
  ...
  INSTPAT("??????? ????? ????? 011 ????? 00000 11", addiw  , I, R(rd)=Ext32(Mr(src1+imm,8)));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(rd)=Ext32((src1<<src2)));
  ...
  INSTPAT("??????? ????? ????? 010 ????? 01000 11", sw     , S, Mw(Ext32(src1 + imm), 4, src2));
