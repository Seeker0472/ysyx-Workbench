...
//
  ...
  INSTPAT("00001?? ????? ????? 010 ????? 01011 11", amoswap.w  , R, uint32_t tmp=Ext8(Mr(src1,1));Mw(src1,1,src2);R(rd)=tmp);
  INSTPAT("00000?? ????? ????? 010 ????? 01011 11", amoadd.w   , R, uint32_t tmp=Ext8(Mr(src1,1));Mw(src1,1,Mr(src1,1)+src2);R(rd)=tmp);
  INSTPAT("00100?? ????? ????? 010 ????? 01011 11", amoxor.w   , R, uint32_t tmp=Ext8(Mr(src1,1));Mw(src1,1,Mr(src1,1)^src2);R(rd)=tmp);
  INSTPAT("01100?? ????? ????? 010 ????? 01011 11", amoand.w   , R, uint32_t tmp=Ext8(Mr(src1,1));Mw(src1,1,Mr(src1,1)&src2);R(rd)=tmp);
  INSTPAT("01000?? ????? ????? 010 ????? 01011 11", amoor.w    , R, uint32_t tmp=Ext8(Mr(src1,1));Mw(src1,1,Mr(src1,1)|src2);R(rd)=tmp);
  INSTPAT("10000?? ????? ????? 010 ????? 01011 11", amomin.w   , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,(signed char)tmp>(signed char)src2?src2:tmp);R(rd)=Ext8(tmp));
  INSTPAT("10100?? ????? ????? 010 ????? 01011 11", amomax.w   , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,(signed char)tmp<(signed char)src2?src2:tmp);R(rd)=Ext8(tmp));
  INSTPAT("11000?? ????? ????? 010 ????? 01011 11", amominu.w  , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,(uint8_t)tmp<(uint8_t)src2?src2:tmp);R(rd)=Ext8(tmp));
  INSTPAT("11100?? ????? ????? 010 ????? 01011 11", amomaxu.w  , R, uint32_t tmp=Mr(src1,1);Mw(src1,1,(uint8_t)tmp<(uint8_t)src2?src2:tmp);R(rd)=Ext8(tmp));
